...
public class GlobalExceptionHandler {
    ...
    @Autowired
    public GlobalExceptionHandler(MessageSource messageSource, LocaleResolver localeResolver, HttpServletRequest request) {
    ...
    private ValidationError processFieldErrors(List<FieldError> fieldErrors) {
        ...
        for (FieldError fieldError : fieldErrors) {
            validationError.addFieldError(fieldError.getField(), messageSource.getMessage(fieldError, localeResolver.resolveLocale(request)));
        }
    ...
    public ResponseEntity<ApiError> handleAccessDeniedException(AccessDeniedException ex) {
        ...
        ApiError body = new ApiError("ACCESS_DENIED_ERROR", "Access denied to the requested method.", ex.getLocalizedMessage());
